...
func (_m *MockQueries) AllLists(ctx context.Context, limit int64) ([]sqlite.List, error) {
...
func (_c *MockQueries_AllLists_Call) Run(run func(ctx context.Context, limit int64)) *MockQueries_AllLists_Call {
...
func (_c *MockQueries_AllLists_Call) Return(_a0 []sqlite.List, _a1 error) *MockQueries_AllLists_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQueries_AllLists_Call) RunAndReturn(run func(context.Context, int64) ([]sqlite.List, error)) *MockQueries_AllLists_Call {
	_c.Call.Return(run)
	return _c
}

// CreateList provides a mock function with given fields: ctx, name
func (_m *MockQueries) CreateList(ctx context.Context, name string) (sqlite.List, error) {
...
func (_c *MockQueries_CreateList_Call) Return(_a0 sqlite.List, _a1 error) *MockQueries_CreateList_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQueries_CreateList_Call) RunAndReturn(run func(context.Context, string) (sqlite.List, error)) *MockQueries_CreateList_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockQueries) GetList(ctx context.Context, id int64) (sqlite.List, error) {
	ret := _m.Called(ctx, id)
...
func (_c *MockQueries_GetList_Call) Return(_a0 sqlite.List, _a1 error) *MockQueries_GetList_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQueries_GetList_Call) RunAndReturn(run func(context.Context, int64) (sqlite.List, error)) *MockQueries_GetList_Call {
	_c.Call.Return(run)
	return _c
}

// RenameList provides a mock function with given fields: ctx, params
func (_m *MockQueries) RenameList(ctx context.Context, params sqlite.RenameListParams) (sqlite.List, error) {
...
func (_e *MockQueries_Expecter) RenameList(ctx interface{}, params interface{}) *MockQueries_RenameList_Call {
	return &MockQueries_RenameList_Call{Call: _e.mock.On("RenameList", ctx, params)}
}

func (_c *MockQueries_RenameList_Call) Run(run func(ctx context.Context, params sqlite.RenameListParams)) *MockQueries_RenameList_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockQueries_RenameList_Call) Return(_a0 sqlite.List, _a1 error) *MockQueries_RenameList_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQueries_RenameList_Call) RunAndReturn(run func(context.Context, sqlite.RenameListParams) (sqlite.List, error)) *MockQueries_RenameList_Call {
	_c.Call.Return(run)
	return _c
}
